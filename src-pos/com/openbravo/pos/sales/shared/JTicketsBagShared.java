...
public class JTicketsBagShared extends JTicketsBag {
    ...
    public void activate() {
        ...
        // Authorisation
        // edit seba  m_App.getAppUserView().getUser().hasPermission("sales.CancelCurrentSale")
        /*m_jDelTicket.setEnabled(m_App.getAppUserView().getUser().hasPermission("sales.CancelCurrentSale"));
       */
        if(m_App.getAppUserView().getUser().hasPermission("sales.CancelCurrentSale")){
            m_jDelTicket.setEnabled(m_App.getAppUserView().getUser().hasPermission("sales.CancelCurrentSale"));
        }
        else{
...
//                    }else{
    ...
    private void selectValidTicket() {
        ...
        try {
            ...
            if (l.isEmpty()) {
     //remove seba           m_jListTickets.setText(m_panelticket.getActiveTicket().getName()); 
                newTicket();
...
//                setActiveTicket(l.get(0).getId());
    ...
    // add seba --------------------------------   tickets bag button name update
    private void setTicketSelectButtonName(String tname)
    {
        m_jListTickets.setText(tname);
    }
    public void updateTicketSelectButtonName()
    {
        // edit seba ------------   ticken name and open tickets display   
        int numtickets = 0;
    ...
    private void initComponents() {
        ...
        m_jNewTicket.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        m_jNewTicket.setToolTipText(bundle.getString("button.newsale")); // NOI18N
        ...
        m_jNewTicket.setPreferredSize(new java.awt.Dimension(80, 40));
        ...
        m_jListTickets.setText(bundle.getString("button.ticketlist")); // NOI18N
        m_jListTickets.setToolTipText(bundle.getString("label.ticketlist")); // NOI18N
        ...
        m_jListTickets.setPreferredSize(new java.awt.Dimension(170, 40));
