...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', 'Glavna skupina');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'DDV 22 %', '000', NULL, NULL, 0.22, FALSE, NULL);
...
VALUES ('xxx999_999xxx_x9x9x9', 'xxx999', 'xxx999', '***', 0.00, 0.00, '000', '000', TRUE, FALSE, FALSE, FALSE,'',FALSE);
...
INSERT INTO LOCATIONS(ID, NAME,ADDRESS) VALUES('0', 'Glavno', NULL);
...
CREATE SEQUENCE TICKETSNUM START WITH 0;
CREATE SEQUENCE TICKETSNUM_REFUND START WITH 0;
CREATE SEQUENCE TICKETSNUM_PAYMENT START WITH 0;
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Pritličje', $FILE{/com/openbravo/pos/templates/restaurant_floor.png});
...
CREATE TABLE RESERVATIONS (
    ...
    DATENEW TIMESTAMP DEFAULT '2015-01-01 00:00:00' NOT NULL,
...
CREATE SEQUENCE PICKUP_NUMBER START WITH 0;
